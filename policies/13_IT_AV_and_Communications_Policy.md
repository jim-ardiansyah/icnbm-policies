...
## 1. Purpose
To manage livestreaming, website, social media, and emergency communication tools responsibly and securely.

## 2. Scope
Applies to all digital platforms operated in ICN Bellevue's name, and all AV equipment used for khutbah recording and livestreaming.

## 3. Policy Statement

### 3.1 Livestream & Recording
- Khutbahs and select events may be livestreamed/recorded for community access (e.g., for those unable to attend in person).
- Camera framing is planned to reasonably minimize close-up capture of the congregation, particularly the women's section, out of respect for privacy.
...
## 4. Procedures
1. IT/Communications Coordinator maintains the list of authorized admins for website/social accounts, reviewed annually.
2. Livestream operator confirms camera framing before each broadcast.
3. Emergency alert templates are pre-drafted for common scenarios (closure, delay, lockdown lifted) to speed response time.
